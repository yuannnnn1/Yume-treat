<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $redirect_to = isset($_POST['redirect_to']) ? $_POST['redirect_to'] : 'main.php';
        ...
        if ($user_data) {
            $is_valid_password = password_verify($password, $user_data['user_password']) || ($password === $user_data['user_password']);
